...
そう言っても本文を見ると至極当然の普通のTodoListをばらせて載せった内容でそこまで特別な内容はないんですが。この内容を把握し
...
列挙するとしても直ぐでないとしたら大きな分類からやってみましょう。 以外にこういう時は曼荼羅図とかを使うのもお勧めです。

![mandara](./images/mandara1024_1.png)
**曼荼羅図**
